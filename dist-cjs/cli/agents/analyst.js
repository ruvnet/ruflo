...
__export(analyst_exports, {
  ...
  createAnalystAgent: () => createAnalystAgent
});
module.exports = __toCommonJS(analyst_exports);
var import_base_agent = require("./base-agent.js");
class AnalystAgent extends import_base_agent.BaseAgent {
  static {
  ...
  async detectAnomalies(task) {
    ...
    anomalies.detected.push(
      {
        id: "anom_001",
        timestamp: /* @__PURE__ */ new Date("2024-01-15"),
        severity: "high",
        score: 0.95,
      ...
      {
        id: "anom_002",
        timestamp: /* @__PURE__ */ new Date("2024-01-16"),
        severity: "medium",
        score: 0.72,
...
const createAnalystAgent = /* @__PURE__ */ __name((id, config, environment, logger, eventBus, memory) => {
  ...
  const defaultEnv = {
    ...
    toolConfigs: {
      dataProcessor: { chunkSize: 1e4, parallel: true },
