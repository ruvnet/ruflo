...
export function generateCompatibilityReport(report: FullValidationReport): string {
  ...
  lines.push("import { UnifiedSwarmCoordinator as HiveMind } from '@claude-flow/agents/swarm';");
  lines.push("import { UnifiedSwarmCoordinator as SwarmCoordinator } from '@claude-flow/agents/swarm';");
  lines.push('```');
  lines.push('');
  lines.push('---');
  lines.push('');
