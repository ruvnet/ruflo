...
var sparc_environment_exports = {};
__export(sparc_environment_exports, {
  createSparcEnvironment: () => createSparcEnvironment
});
module.exports = __toCommonJS(sparc_environment_exports);
async function createSparcEnvironment() {
...
__name(createSparcEnvironment, "createSparcEnvironment");
...
__name(createRoomodes, "createRoomodes");
function createClaudeMd() {
  return `# Claude Code Configuration for Your Project

## \u{1F3AF} Purpose of This Configuration
...
## \u{1F6E0}\uFE0F Your Project's Build Commands
...
## \u{1F680} Using Claude-Flow to Build Your Application
...
### \u{1F3AE} Getting Started with Your Project
...
### \u{1F916} AI Agents to Build Your Application
...
### \u{1F4CB} Managing Your Development Tasks
...
### \u{1F9E0} Project Knowledge Management
...
### \u{1F3AF} SPARC Modes for Building Your Application
...
### \u{1F41D} Swarm Mode: Multiple AI Agents for Your Project
...
## \u{1F4A1} Example Workflows for Your Projects

### \u{1F680} Building a New Web Application
\`\`\`bash
...
### \u{1F50D} Research Phase for Your Project
\`\`\`bash
...
### \u{1F3D7}\uFE0F Development Workflow for Your Application
\`\`\`bash
...
### \u{1F527} Testing and Debugging Your Application
\`\`\`bash
...
### \u{1F4DA} Documentation for Your Project
\`\`\`bash
...
## \u{1F3A8} Building Your Application Step by Step

### \u{1F4D0} Planning Your Application
...
### \u{1F3D7}\uFE0F Building Your Application Features
...
### \u{1F680} Deploying Your Application
...
## \u{1F6E0}\uFE0F How Claude Code Helps Build YOUR Application

### \u{1F916} AI-Powered Development Assistance
...
### \u{1F4CB} Task Management for YOUR Project
...
### \u{1F50D} Analysis & Research Modes
...
## \u{1F41D} Swarm Mode: Multiple AI Agents for Complex Features
...
## \u{1F4BB} Code Style for YOUR Project
...
## \u{1F389} Get Started Building YOUR Application!
...
__name(createClaudeMd, "createClaudeMd");
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  createSparcEnvironment
});
//# sourceMappingURL=sparc-environment.js.map
