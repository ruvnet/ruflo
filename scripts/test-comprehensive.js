...
/**
 * Comprehensive Test Runner for Gemini Flow v2.0.0
 */
...
const dockerTests = [
  ...
  },
  {
    ...
    command: 'docker',
    args: ['run', '--rm', 'gemini-flow:test', 'gemini-flow', '--version'],
...
class TestRunner {
  ...
  async run() {
    this.log('🚀 Starting Gemini Flow v2.0.0 Comprehensive Test Suite');
...
function showHelp() {
  console.log(`
${chalk.bold.blue('Gemini Flow v2.0.0 Comprehensive Test Runner')}
