...
__export(coordinator_exports, {
  ...
  createCoordinatorAgent: () => createCoordinatorAgent
});
module.exports = __toCommonJS(coordinator_exports);
var import_base_agent = require("./base-agent.js");
class CoordinatorAgent extends import_base_agent.BaseAgent {
  static {
    __name(this, "CoordinatorAgent");
  }
  ...
  async trackProgress(task) {
    ...
    const progress = {
      ...
      timeline: {
        on_track: true,
        estimated_completion: /* @__PURE__ */ new Date(),
        delays: []
      },
      recommendations: [],
      timestamp: /* @__PURE__ */ new Date()
...
const createCoordinatorAgent = /* @__PURE__ */ __name((id, config, environment, logger, eventBus, memory) => {
  const defaultConfig = {
    autonomyLevel: 0.9,
    learningEnabled: true,
    adaptationEnabled: true,
