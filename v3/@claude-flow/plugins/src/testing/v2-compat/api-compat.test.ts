...
const IMPORT_ALIASES: Record<string, string> = {
  'claude-flow/hive-mind': '@claude-flow/agents/swarm',
  'claude-flow/swarm': '@claude-flow/agents/swarm',
  ...
  'claude-flow/hooks': '@claude-flow/agents/hooks',
...
describe('V2 API Compatibility', () => {
  ...
  describe('Import Path Aliases', () => {
    ...
    it('should resolve claude-flow/hive-mind to @claude-flow/swarm', () => {
      ...
      expect(resolved).toBe('@claude-flow/agents/swarm');
    });
