...
var coder_exports = {};
__export(coder_exports, {
  CoderAgent: () => CoderAgent,
  createCoderAgent: () => createCoderAgent
});
module.exports = __toCommonJS(coder_exports);
var import_base_agent = require("./base-agent.js");
class CoderAgent extends import_base_agent.BaseAgent {
  static {
...
`;
  ...
  generateBuildInstructions(language, framework) {
    ...
    return instructions[language] || ["Build instructions not available"];
  }
  async delay(ms) {
...
const createCoderAgent = /* @__PURE__ */ __name((id, config, environment, logger, eventBus, memory) => {
  const defaultConfig = {
    autonomyLevel: 0.7,
    learningEnabled: true,
    adaptationEnabled: true,
