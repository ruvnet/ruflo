...
var architect_exports = {};
__export(architect_exports, {
  ArchitectAgent: () => ArchitectAgent,
  createArchitectAgent: () => createArchitectAgent
});
module.exports = __toCommonJS(architect_exports);
...
class ArchitectAgent extends import_base_agent.BaseAgent {
  ...
  getDefaultConfig() {
    return {
      ...
      maxTasksPerHour: 8,
      maxConcurrentTasks: 2,
      timeoutThreshold: 24e5,
      reportingInterval: 9e4,
...
const createArchitectAgent = /* @__PURE__ */ __name((id, config, environment, logger, eventBus, memory) => {
  const defaultConfig = {
    autonomyLevel: 0.8,
    learningEnabled: true,
    adaptationEnabled: true,
