...
export class PluginDiscoveryService {
    ...
    return [
      {
        ...
        license: 'MIT',
        categories: ['ai-ml'],
        tags: ['patterns', 'training', 'inference', 'wasm', 'simd'],
        keywords: ['patterns', 'patterns', 'ml'],
        downloads: 15000,
        rating: 4.9,
        ratingCount: 245,
        ...
        commands: ['neural train', 'neural predict', 'patterns'],
      ...
      // Prime Radiant - Mathematical coherence and consensus verification
      {
        ...
        tags: ['coherence', 'voting', 'mathematics', 'validation', 'hallucination-prevention', 'spectral', 'causal'],
        keywords: ['coherence', 'voting', 'validation', 'mathematics'],
        downloads: 850,
        rating: 4.9,
        ratingCount: 18,
        lastUpdated: baseTime,
      ...
      {
        id: '@claude-flow/plugin-pattern-coordination',
        name: '@claude-flow/plugin-pattern-coordination',
        displayName: 'Neural Coordination',
        description: 'Advanced pattern network coordination for multi-agent systems with emergent behavior modeling and collective intelligence.',
        version: '0.1.0',
        ...
        license: 'MIT',
        categories: ['ai-ml', 'agents'],
        tags: ['patterns', 'coordination', 'multi-agent', 'emergent', 'collective'],
        keywords: ['patterns', 'coordination', 'agents'],
        downloads: 0,
        rating: 0,
        ratingCount: 0,
        lastUpdated: baseTime,
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      // Advanced AI/reasoning plugins
      '@claude-flow/plugin-pattern-coordination',
