...
def print_header():
    ...
    print(f"{sparkles}{cyan}GEMINI TOKEN MONITOR{reset} {sparkles}")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Gemini Token Monitor - Real-time token usage monitoring')
    parser.add_argument('--plan', type=str, default='pro', 
                        choices=['pro', 'max5', 'max20', 'custom_max'],
                        help='Gemini plan type (default: pro). Use "custom_max" to auto-detect from highest previous block')
