 ...
 *      %VAR% expansion (which quoting cannot suppress and carets do not
 *      reliably escape).
 ...
 * copies can be diffed against each other. See the %VAR% note below for the
 * case this does not close, which is why resolveInvocation() above is
 * preferred and this is only the fallback.
 */
