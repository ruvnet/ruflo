...
async function basicMigration() {
  ...
  if (analysis.hasClaudeFolder) {
    console.log(chalk.green('   ✓ Found existing .gemini folder'));
  } else {
    console.log(chalk.yellow('   ! No .gemini folder found - fresh installation'));
  }
...
// Main execution
async function main() {
  console.log(chalk.bold.blue('\n🚀 Gemini-Flow Migration Examples\n'));
