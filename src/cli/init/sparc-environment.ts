...
function createClaudeMd(): string {
  return `# Gemini Code Configuration for Your Project

## 🎯 Purpose of This Configuration
This CLAUDE.md file configures Gemini Code to help you BUILD YOUR OWN APPLICATIONS using the gemini-flow orchestration system. Claude-flow is a tool to help you develop software - it is NOT the project you should be modifying.

**IMPORTANT**: 
- Use gemini-flow commands to BUILD YOUR APPLICATION
- DO NOT modify the gemini-flow system itself
...
Configure these for YOUR application (not gemini-flow):
...
## 🚀 Using Gemini-Flow to Build Your Application
...
- \`./gemini-flow start --ui\`: Start the AI orchestration system to help build YOUR app
- \`./gemini-flow sparc "Build a [YOUR APP TYPE] application"\`: Start building YOUR application
- \`./gemini-flow swarm "Create [YOUR FEATURE]"\`: Use multiple AI agents to build complex features
- \`./gemini-flow status\`: Check the status of YOUR development tasks

### 🤖 AI Agents to Build Your Application
- \`./gemini-flow agent spawn coder\`: Create a coding agent for YOUR project
- \`./gemini-flow agent spawn researcher\`: Research best practices for YOUR features
- \`./gemini-flow agent spawn tester\`: Create tests for YOUR application
- \`./gemini-flow agent list\`: See agents working on YOUR project

### 📋 Managing Your Development Tasks
- \`./gemini-flow task create feature "Add user authentication to my app"\`: Create development tasks
- \`./gemini-flow task list\`: View YOUR project's task queue
- \`./gemini-flow workflow my-app-workflow.json\`: Automate YOUR development workflow

### 🧠 Project Knowledge Management
- \`./gemini-flow memory store "my_app_architecture" "REST API with React frontend"\`: Store YOUR project decisions
- \`./gemini-flow memory get "my_app_requirements"\`: Retrieve YOUR project information
- \`./gemini-flow memory list\`: See all stored knowledge about YOUR project
- \`./gemini-flow memory export my-project-knowledge.json\`: Export YOUR project knowledge

### 🎯 SPARC Modes for Building Your Application
- \`./gemini-flow sparc "Create a todo list app with React"\`: Start building YOUR app
- \`./gemini-flow sparc run coder "Implement user login for my app"\`: Code YOUR features
- \`./gemini-flow sparc tdd "Shopping cart functionality"\`: Build YOUR features test-first
- \`./gemini-flow sparc run architect "Design my app's database schema"\`: Design YOUR architecture
...
\`./gemini-flow swarm "Build a complete e-commerce website" --strategy development --parallel\`
...
./gemini-flow sparc "Create a task management web app with React and Node.js"

# Add authentication to YOUR app
./gemini-flow sparc run coder "Add user authentication with JWT tokens to my task app"

# Create tests for YOUR features
./gemini-flow sparc tdd "Task creation and assignment features"

# Use multiple agents to build faster
./gemini-flow swarm "Build complete task management system" --strategy development --parallel
\`\`\`

### 🔍 Research Phase for Your Project
\`\`\`bash
# Research best practices for YOUR app type
./gemini-flow sparc run researcher "Research best practices for building SaaS applications"

# Store YOUR project's technical decisions
./gemini-flow memory store "tech_stack" "React, Node.js, PostgreSQL, Redis"
./gemini-flow memory store "auth_strategy" "JWT with refresh tokens"

# Analyze similar applications
./gemini-flow sparc run analyzer "Analyze successful task management apps for feature ideas"
\`\`\`

### 🏗️ Development Workflow for Your Application
\`\`\`bash
# Design YOUR application architecture
./gemini-flow sparc run architect "Design microservices architecture for my e-commerce platform"

# Implement YOUR features with TDD
./gemini-flow sparc tdd "Shopping cart with discount calculation"

# Multiple agents working on YOUR project
./gemini-flow swarm "Build user dashboard with analytics" --strategy development --max-agents 5

# Review and optimize YOUR code
./gemini-flow sparc run reviewer "Review authentication implementation for security"
\`\`\`

### 🔧 Testing and Debugging Your Application
\`\`\`bash
# Comprehensive testing for YOUR app
./gemini-flow sparc run tester "Create comprehensive test suite for my API endpoints"

# Debug issues in YOUR application
./gemini-flow sparc run debugger "Debug why user login is failing in production"

# Performance optimization for YOUR app
./gemini-flow sparc run optimizer "Optimize database queries in my application"

# Security review for YOUR project
./gemini-flow sparc run reviewer "Security audit of my payment processing system"
\`\`\`

### 📚 Documentation for Your Project
\`\`\`bash
# Generate documentation for YOUR API
./gemini-flow sparc run documenter "Create API documentation for my REST endpoints"

# Document YOUR project architecture
./gemini-flow sparc run documenter "Document the system architecture and design decisions"

# Create user guides for YOUR application
./gemini-flow sparc run documenter "Write user guide for the admin dashboard"
\`\`\`
...
./gemini-flow memory store "app_type" "SaaS project management tool"
./gemini-flow memory store "target_users" "Small to medium development teams"
./gemini-flow memory store "core_features" "Task tracking, team collaboration, time tracking, reporting"

# Design YOUR architecture based on requirements
./gemini-flow sparc run architect "Design scalable SaaS architecture for project management tool"

# Research best practices for YOUR app type
./gemini-flow sparc run researcher "Research best practices for multi-tenant SaaS applications"
\`\`\`
...
./gemini-flow sparc tdd "User registration and team creation"
./gemini-flow sparc run coder "Implement project and task management features"

# Phase 2: Advanced features
./gemini-flow swarm "Build real-time collaboration features" --strategy development --parallel
./gemini-flow sparc run coder "Add time tracking and reporting dashboard"

# Phase 3: Polish and optimize
./gemini-flow sparc run optimizer "Optimize performance for 1000+ concurrent users"
./gemini-flow sparc run designer "Improve UI/UX for mobile responsiveness"
\`\`\`
...
./gemini-flow sparc run tester "Complete end-to-end testing suite"
./gemini-flow sparc run reviewer "Final security audit before launch"

# Documentation for YOUR users
./gemini-flow sparc run documenter "Create user documentation and API guides"

# Performance optimization
./gemini-flow sparc run optimizer "Optimize for production deployment"
\`\`\`

## 🛠️ How Gemini Code Helps Build YOUR Application

### 🤖 AI-Powered Development Assistance
When you use gemini-flow commands, Gemini Code will help you:
- **Write code** for YOUR application (not for gemini-flow itself)
...
Gemini Code uses TodoWrite and TodoRead to manage YOUR development tasks:

\`\`\`javascript
// Example: Gemini Code will create tasks for YOUR application development
TodoWrite([
  {
...
./gemini-flow swarm "Build complete e-commerce platform with payment integration" \\
  --strategy development --parallel --max-agents 8

# Example: Adding real-time features to YOUR app
./gemini-flow swarm "Add real-time chat and notifications to my app" \\
  --strategy development --parallel --max-agents 5

# Example: Comprehensive testing of YOUR application
./gemini-flow swarm "Create comprehensive test suite for my API" \\
  --strategy testing --parallel --max-agents 6
\`\`\`

## 💻 Code Style for YOUR Project

When Gemini Code writes code for YOUR application, it will follow these best practices:
...
### ❌ DON'T Use Gemini-Flow For:
- Modifying the gemini-flow system itself
- Changing how gemini-flow works internally
- Updating gemini-flow commands or features
- Fixing gemini-flow bugs (report them on GitHub instead)
...
\`\`\`bash
./gemini-flow sparc "Create a [YOUR APP TYPE] application with [YOUR MAIN FEATURES]"
\`\`\`
