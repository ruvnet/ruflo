...
1. **Integration Planning** (10 mins)
   ...
   - Plan data mappings
   - Store plan: \`npx gemini-flow memory store ${memoryNamespace}_mcp_plan "..."\`
...
2. **Connection Setup** (15 mins)
   ...
   - Store config: \`npx gemini-flow memory store ${memoryNamespace}_mcp_config "..."\`
...
3. **Data Integration** (20 mins)
   ...
   - Store integration: \`npx gemini-flow memory store ${memoryNamespace}_mcp_integration "..."\`
