...
var swarm_commands_exports = {};
__export(swarm_commands_exports, {
  createSwarmCommands: () => createSwarmCommands
});
module.exports = __toCommonJS(swarm_commands_exports);
async function createSwarmCommands() {
...
__name(createSwarmCommands, "createSwarmCommands");
function createResearchCommand() {
...
__name(createResearchCommand, "createResearchCommand");
function createDevelopmentCommand() {
...
__name(createDevelopmentCommand, "createDevelopmentCommand");
function createAnalysisCommand() {
...
__name(createAnalysisCommand, "createAnalysisCommand");
function createTestingCommand() {
...
__name(createTestingCommand, "createTestingCommand");
function createOptimizationCommand() {
...
__name(createOptimizationCommand, "createOptimizationCommand");
...
__name(createMaintenanceCommand, "createMaintenanceCommand");
function createSwarmExamples() {
...
__name(createSwarmExamples, "createSwarmExamples");
function createCoordinationModes() {
...
__name(createCoordinationModes, "createCoordinationModes");
...
__name(createBestPractices, "createBestPractices");
...
\`\`\`
\u{1F4CA} Progress Overview
   \u251C\u2500\u2500 Total Tasks: 12
   \u251C\u2500\u2500 \u2705 Completed: 8 (67%)
   \u251C\u2500\u2500 \u{1F504} In Progress: 2 (17%)
   \u251C\u2500\u2500 \u2B55 Todo: 1 (8%)
   \u2514\u2500\u2500 \u274C Blocked: 1 (8%)
\`\`\`
...
\`\`\`
\u{1F4CB} Todo (1)
   \u2514\u2500\u2500 \u{1F534} 001: Set up authentication system [HIGH] \u25B6
\`\`\`

### \u{1F504} In Progress Tasks
Tasks currently being worked on:
\`\`\`
\u{1F504} In progress (2)
   \u251C\u2500\u2500 \u{1F7E1} 002: Implement user dashboard \u21B3 1 deps \u25B6
   \u2514\u2500\u2500 \u{1F534} 003: Add payment integration [CRITICAL] \u25B6
\`\`\`
...
\`\`\`
\u274C Blocked (1)
   \u2514\u2500\u2500 \u{1F534} 007: Deploy to production \u21B3 3 deps [BLOCKED]
\`\`\`

## Priority Indicators

Tasks use color-coded priority indicators:
- \u{1F534} **HIGH/CRITICAL**: Urgent tasks requiring immediate attention
- \u{1F7E1} **MEDIUM**: Important tasks that should be addressed soon
- \u{1F7E2} **LOW**: Tasks that can be deferred if needed
...
\`\`\`
\u{1F41D} Swarm: Build E-commerce Platform
\u{1F4CA} Progress Overview
   \u251C\u2500\u2500 Total Tasks: 25
   \u251C\u2500\u2500 \u2705 Completed: 15 (60%)
   \u251C\u2500\u2500 \u{1F504} In Progress: 5 (20%)
   \u251C\u2500\u2500 \u2B55 Todo: 4 (16%)
   \u2514\u2500\u2500 \u274C Blocked: 1 (4%)

\u{1F4CB} Todo (4)
   \u251C\u2500\u2500 \u{1F534} 008: Implement cart functionality [HIGH] \u25B6
   \u251C\u2500\u2500 \u{1F7E1} 009: Add product search \u25B6
   \u251C\u2500\u2500 \u{1F7E1} 010: Create order history page \u25B6
   \u2514\u2500\u2500 \u{1F7E2} 011: Add social sharing buttons [LOW] \u25B6

\u{1F504} In progress (5)
   \u251C\u2500\u2500 \u{1F534} 012: Payment gateway integration [CRITICAL] 
   \u251C\u2500\u2500 \u{1F534} 013: User authentication system [HIGH] 
   \u251C\u2500\u2500 \u{1F7E1} 014: Product catalog implementation \u21B3 2 deps 
   \u251C\u2500\u2500 \u{1F7E1} 015: Shopping cart API endpoints 
   \u2514\u2500\u2500 \u{1F7E2} 016: Email notification service 
...
\u274C Blocked (1)
   \u2514\u2500\u2500 \u{1F534} 017: Deploy to production \u21B3 5 deps [BLOCKED]
\`\`\`
...
__name(createTaskTracking, "createTaskTracking");
