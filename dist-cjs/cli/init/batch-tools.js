...
var batch_tools_exports = {};
__export(batch_tools_exports, {
  createBatchToolsGuide: () => createBatchToolsGuide
});
module.exports = __toCommonJS(batch_tools_exports);
async function createBatchToolsGuide() {
...
__name(createBatchToolsGuide, "createBatchToolsGuide");
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  createBatchToolsGuide
});
