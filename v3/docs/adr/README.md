...
| [ADR-381](ADR-381-sequential-promotion-evidence-governance.md) | Sequential Promotion Evidence: α-Stream Governance, Reset Epochs, and accept/v2+seq | Proposed |
| [ADR-382](ADR-382-dream-cycle-security-chain-risk-accumulator.md) | ChainRiskAccumulator — Cross-Tool Sequential Injection Correlation | Proposed |
