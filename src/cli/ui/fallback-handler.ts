...
async function showBasicInterface(options: FallbackOptions): Promise<void> {
  ...
  console.log(chalk.gray('   ./gemini-flow status'));
  console.log(chalk.gray('   ./gemini-flow memory list'));
  console.log(chalk.gray('   ./gemini-flow sparc modes'));
  console.log();
  console.log(chalk.white('2. Use non-interactive modes:'));
  console.log(chalk.gray('   ./gemini-flow start (without --ui)'));
  console.log(chalk.gray('   ./gemini-flow swarm "task" --monitor'));
  console.log();
  ...
  if (options.showHelp) {
    ...
    console.log(chalk.gray('   ./gemini-flow help <command>'));
    console.log(chalk.gray('   ./gemini-flow <command> --help'));
    console.log();
  }
