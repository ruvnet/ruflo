...
export function showInitHelp() {
  console.log('Initialize Gemini Code integration files with Gemini Flow v2.0.0');
  console.log();
  console.log('Usage: gemini-flow init [options]');
  console.log();
  console.log('🚀 DEFAULT BEHAVIOR:');
  console.log('  gemini-flow init     Initialize with Gemini Flow v2.0.0 enhanced features');
  ...
  console.log('  --skip-mcp           Skip automatic MCP server setup in Gemini Code');
  console.log();
  ...
  console.log('  gemini-flow init                    # ⭐ DEFAULT: Full Gemini Flow v2.0.0 setup');
  console.log('  gemini-flow init --force            # Overwrite existing configuration');
  console.log('  gemini-flow init --dry-run          # Preview what will be created');
  console.log();
  console.log('🚀 STANDARD INITIALIZATION:');
  console.log('  npx gemini-flow@latest init --sparc --force  # ⭐ RECOMMENDED: Optimized setup');
  console.log('  npx gemini-flow@latest init --sparc          # Standard SPARC setup');
  console.log('  gemini-flow init --sparc --force             # Optimized setup (existing project)');
  console.log('  gemini-flow init --sparc --modes architect,tdd,code  # Selective initialization');
  console.log('  gemini-flow init --dry-run --sparc          # Preview initialization');
  console.log('  gemini-flow init --minimal                  # Minimal setup');
  console.log();
  console.log('🔄 VALIDATION & ROLLBACK:');
  console.log('  gemini-flow init --validate                 # Validate existing setup');
  console.log('  gemini-flow init --rollback --full          # Full system rollback');
  console.log('  gemini-flow init --rollback --partial --phase sparc-init  # Rollback SPARC only');
  console.log('  gemini-flow init --list-backups             # Show available backups');
  console.log();
  ...
  console.log('  • .claude/commands/ directory with 20+ Gemini Code slash commands');
  ...
  console.log('  • ./gemini-flow local executable wrapper');
  ...
  console.log();
  console.log('Gemini Code Slash Commands Created:');
  console.log('  • /sparc - Execute SPARC methodology workflows');
  console.log('  • /sparc-<mode> - Run specific SPARC modes (17+ modes)');
  console.log('  • /gemini-flow-help - Show all gemini-flow commands');
  console.log('  • /gemini-flow-memory - Interact with memory system');
  console.log('  • /gemini-flow-swarm - Coordinate multi-agent swarms');
  console.log();
  ...
  console.log();
  console.log('Learn more: https://github.com/ruvnet/gemini-flow');
}