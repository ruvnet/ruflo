...
var mcp_integration_wrapper_exports = {};
__export(mcp_integration_wrapper_exports, {
  MCPIntegrationWrapper: () => MCPIntegrationWrapper,
  default: () => mcp_integration_wrapper_default
});
module.exports = __toCommonJS(mcp_integration_wrapper_exports);
var import_node_events = require("node:events");
var import_logger = require("../core/logger.js");
var import_helpers = require("../utils/helpers.js");
var import_claude_flow_tools = require("../mcp/claude-flow-tools.js");
var import_ruv_swarm_tools = require("../mcp/ruv-swarm-tools.js");
class MCPIntegrationWrapper extends import_node_events.EventEmitter {
  static {
    __name(this, "MCPIntegrationWrapper");
  }
  logger;
  config;
  toolRegistry;
  ...
  constructor(config = {}) {
    super();
    this.logger = new import_logger.Logger("MCPIntegrationWrapper");
  ...
  async executeTool(toolName, input, context) {
    const executionId = (0, import_helpers.generateId)("mcp-execution");
    ...
    return results.map((result, index) => {
      if (result.status === "fulfilled") {
        ...
        return {
          ...
          metadata: {
            timestamp: /* @__PURE__ */ new Date(),
            executionId: (0, import_helpers.generateId)("failed-execution"),
            attempts: 1
          }
        };
      }
  ...
  createExecutionContext(orchestrator, agent, swarmId, task) {
    return {
      sessionId: (0, import_helpers.generateId)("mcp-session"),
      orchestrator,
      agent,
      task,
      swarmId,
      executionId: (0, import_helpers.generateId)("mcp-execution"),
  ...
  hasPermission(tool, agent) {
    ...
    return agent.capabilities.some(
      (capability) => toolPermissions.includes(capability)
    );
  }
...
var mcp_integration_wrapper_default = MCPIntegrationWrapper;
