...
__export(tester_exports, {
  ...
  createTesterAgent: () => createTesterAgent
});
module.exports = __toCommonJS(tester_exports);
var import_base_agent = require("./base-agent.js");
class TesterAgent extends import_base_agent.BaseAgent {
  static {
    __name(this, "TesterAgent");
  }
...
const createTesterAgent = /* @__PURE__ */ __name((id, config, environment, logger, eventBus, memory) => {
  const defaultConfig = {
    autonomyLevel: 0.7,
    learningEnabled: true,
    adaptationEnabled: true,
