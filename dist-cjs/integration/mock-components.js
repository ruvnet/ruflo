...
var mock_components_exports = {};
__export(mock_components_exports, {
  MockAgentManager: () => MockAgentManager,
  MockConfigManager: () => MockConfigManager,
  MockMcpServer: () => MockMcpServer,
  MockMemoryManager: () => MockMemoryManager,
  MockOrchestrator: () => MockOrchestrator,
  MockRealTimeMonitor: () => MockRealTimeMonitor,
  MockSwarmCoordinator: () => MockSwarmCoordinator,
  MockTaskEngine: () => MockTaskEngine
});
module.exports = __toCommonJS(mock_components_exports);
class MockConfigManager {
  static {
    __name(this, "MockConfigManager");
  }
  config = {};
  static getInstance() {
...
class MockSwarmCoordinator {
  ...
  static {
    __name(this, "MockSwarmCoordinator");
  }
...
class MockRealTimeMonitor {
  ...
  static {
    __name(this, "MockRealTimeMonitor");
  }
  async initialize() {
  }
  async shutdown() {
