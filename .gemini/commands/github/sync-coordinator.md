...
## Purpose
Multi-package synchronization and version alignment with ruv-swarm coordination for seamless integration between gemini-flow and ruv-swarm packages.
...
- `mcp__gemini-flow__*` (all swarm coordination tools)
...
mcp__gemini-flow__swarm_init { topology: "hierarchical", maxAgents: 5 }
